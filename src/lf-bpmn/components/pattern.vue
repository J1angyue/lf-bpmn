<template>
  <div class="pattern">
    ...
    <div>开始</div>
    <div class="pattern-user" @mousedown="addUserTask"></div>
    <div>用户任务</div>
    <div class="pattern-user" @mousedown="addServiceTask"></div>
    <div>系统任务</div>
    <div class="pattern-condition" @mousedown="addGateWay"></div>
    <div>网关分支</div>
    <div class="pattern-end" @mousedown="addEndNode"></div>
    <div>结束</div>
    <div @mousedown="logBpmnXML">输出</div>
  </div>
</template>

<script setup>
const lf = inject('lfRef')
...
function logBpmnXML() {
  ...
  console.log(lf.value.getGraphRawData())
}
